...
-   ejecutan programas
-   almacenan datos
-   se comunican entre ellas, e
-   interactúan con nosotros

Pueden hacer lo anterior de muchas formas diferentes,
incluyendo enlaces directos cerebro-computador y reconocimiento de voz, usando sistemas como Alexa o Google Home.
Mientras estas interfaces de hardware se hacen más comunes, la mayor parte de la interacción aún
se realiza mediante pantallas, ratones, superficies táctiles y teclados.
Aunque la mayoría de los sistemas operativos modernos se comunican con sus usuarios humanos
mediante ventanas, iconos y apuntadores, estas tecnologías de software no se habían
difundido hasta los 1980s. Las raíces de estas *interfaces gráficas de usuario* se remontan
a la obra de Doug Engelbart en los 1960s, que se puede ver en lo que se ha
llamado "[La Madre de Todos los Demos](http://www.youtube.com/watch?v=a11JDLBXtPQ)".
